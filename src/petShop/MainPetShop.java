...
public class MainPetShop {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("4 - Verifica a água da maquina");
            System.out.println("5 - Verifica o shampoo da maquina");
    ...
    private static void verifyWater() {
        ...
        System.out.println("Quantidade de água na máquina: " + amout);
    }

    private static void verifyShampoo() {
        var amout = petMachine.getShampoo();
        System.out.println("Quantidade de shampoo na máquina: " + amout);
    }
